...
export default function ConceptosIngresos() {
    ...
    const guardarCambios = async () => {
        if (conceptoIngreso.trim() === "") {
            ...
            if (modoEdicion && conceptoSeleccionado) {
                await editarConceptoIngreso(conceptoIngreso, conceptoSeleccionado.id);
                Alert.alert("Éxito", "Concepto actualizado correctamente ✅");
            } else {
                await guardarConceptoIngreso(conceptoIngreso);
    ...
    const abrirModalEditar = (item: any) => {
        ...
        setConceptoIngreso(item.concepto);
        setModalVisible(true);
    };
        ...
        Alert.alert(
            ...
            [
                { text: "Cancelar", style: "cancel" },
                {
                    ...
                    onPress: async () => {
                        try {
                            await eliminarConceptoIngreso(item.id);
    ...
    return (
        <View style={styles.container}>
            <View style={styles.header}>
                <Text style={styles.title}>Conceptos de Ingresos</Text>
                <Text style={styles.subtitle}>Gestiona los conceptos de tus ingresos mensuales</Text>
            </View>
